...
public:
    void create() {
        headnode = new head(); // Create a new node of type head and assign it to headnode
        headnode->count = 0; // Set the count of headnode to 0
        headnode->first = NULL; // Set the first pointer of headnode to NULL
    }
    ...
    bool insert(int x) {
        ...
        if (ppre == NULL) { /// Insert at the head
