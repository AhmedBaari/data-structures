...
public:
    ...
    // If the node to be deleted is the head node, updates the head node to the next node.
    // If the node to be deleted is the rear node, updates the rear node to the previous node.
    // Decrements the count of nodes in the list.
    // Parameters:
...
int main() {
    ...
    int pos;
    do {
        cout << "1.insert 2.delete 3.searchDLLfromhead 4.searchDLLfromrear 5.destroyDLL\n ";
        cin >>choice;
        switch (choice) {
        case 1:
